...
sudo kubeadm init --control-plane-endpoint="<private-ip-of-k8s-loadbalancer-ec2>:6443" --upload-certs --apiserver-advertise-address=<private-ip-of-k8s-master-1-ec2>
